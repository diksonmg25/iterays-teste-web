...
//		assertTrue(homePage.estaLogado("Marcelo Bittencourt"));
	...
	@After(order = 1) //  Colocar um numero de ordem maior faz com que o metodo seja executado primeiro 
	...
	@After(order = 0) // Colocar um numero de ordem menor faz com que o metodo seja executado por ultimo 
