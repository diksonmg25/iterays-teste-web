...
public class ModalProdutoPage {
	...
	public String obterMensagemProdutoAdicionado() {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10); // WAIT ----- ESPERA IMPLICITA 
	...
	public CarrinhoPage clicarBotaoProceedToCheckout() { // CarrinhoPage ---- tipo de objeto que sera retornado 
